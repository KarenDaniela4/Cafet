                        ...
                        Producto: <?php echo $value['IdProducto']; ?>
                                <div class="col-lg-4 wow fadeIn"  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="text" value="<?php echo $value['IdProducto']; ?>" name="IdProducto" placeholder="IdProducto"/>
                                ...
                                <div class="col-lg-4 wow "  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="text" value="<?php echo $value['Producto']; ?>" placeholder="Producto" name="Producto" />
                                ...
                                <div class="col-lg-4 wow fadeIn"  data-wow-duration="700ms" data-wow-delay="300ms">
                                    <div class="contact_form">
                                        ...
                                        <input type="text" value="<?php echo $value['Precio']; ?>"  placeholder="Precio" name="Precio" />
