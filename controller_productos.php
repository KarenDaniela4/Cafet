    ...
    static public function editar() {
        try {
            ...
            $arrayproductos['IdProducto'] = $_POST['IdProducto'];
                ...
                $productos = new productos($arrayproductos);
                $productos->editar();
          echo"<script languaje='javascript'>window.location='../frontend/productos.php?respuesta=correcto&o=modificad'</script>;";
        } catch (Exception $e) {
            echo"<script languaje='javascript'>window.location='../frontend/productos.php?respuesta=error&o=modificad'</script>;";
        }
    }
